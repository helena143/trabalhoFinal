  ...
  <AdminLayout>
    ...
    <div v-else class="product-grid">
      <div class="product-card" v-for="p in products" :key="p._id">
        <img v-if="p.image" :src="`http://localhost:3000${p.image}`" />
        ...
        <div class="card-body">
          ...
          <div class="actions">
            ...
            <button class="delete-btn" @click="deleteProduct(p._id)">
              Deletar
            </button>
          </div>
        </div>
    ...
    <div v-if="showModal" class="modal-overlay" @click.self="closeModal">
      <div class="modal">
        ...
        <div class="form-group">
          <label>Categoria (ID Mongo)</label>
...
/* =====================
   SALVAR PRODUTO (AQUI É O IMPORTANTE)
===================== */
const saveProduct = async () => {
  ...
  const url = editing.value
    ? `${API}/api/products/${editing.value._id}`
    : `${API}/api/products`
